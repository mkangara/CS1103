...
public class IconSupport {
	...
	/**
	 * xxxxxxxxxxxxxxx my addition xxxxxxxxxxxxxxx
	 * Return a menu containing buttons representing the images that can be added
	 * to the DrawPanel.
	 * @param 
	 */
	public JMenu createMenu() {
		...
		for (int i = 0; i < actions.size() -1; i++) {
			stamper.add(new JMenuItem(actions.get(i)));
		}
